//! Shim: the payload helpers live in the harness kit (`netem_test::kit::payload`,
...
//! targets import `support::payload::…`; targets that compile the module while
//! using none of its items legitimately leave it unused, so the import is
//! deliberately allowed.
#[allow(unused_imports)]
pub use netem_test::kit::payload::*;
