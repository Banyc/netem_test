//! Shim: the task_scope helpers live in the harness kit (`netem_test::kit::task_scope`,
...
//! targets import `support::task_scope::…`; targets that compile the module while
//! using none of its items legitimately leave it unused, so the import is
//! deliberately allowed.
#[allow(unused_imports)]
pub use netem_test::kit::task_scope::*;
